...
public class DemandePropriete {
    ...
    public DemandePropriete(int id, String emplacement, double superficie, int nbPieces, int nbSalleBain, int nbSalleEau, String description, double prix, String adresse, List<String> photos, String vendeur, String ville, int statut, String employe, String titre) {
        this.id = id;
